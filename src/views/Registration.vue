    ...
    <div class="w-1/3">
      ...
      <form @submit.prevent="addNewRegistrationToDd">
        <div class="mb-4" :class="{ 'form-group-error': v$.newRegistration.name.$error }">
          ...
          <input type="text" id="name" class="w-full px-4 py-2 border border-green-500 rounded" v-model="newRegistration.name" @blur="v$.newRegistration.name.$touch()"/>
